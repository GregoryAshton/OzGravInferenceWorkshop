...
injection_parameters = dict(mass_1=36., mass_2=29., a_1=0.4, a_2=0.3, tilt_1=0.5, tilt_2=1.0, phi_12=1.7, phi_jl=0.3,
                            luminosity_distance=400., iota=0.4, psi=2.659, phase=1.3, geocent_time=1126259642.413,
                            ra=1.375, dec=-1.2108)
...
priors['luminosity_distance'] = tupak.prior.Uniform(100, 500, 'luminosity_distance')
for key in ['a_1', 'a_2', 'tilt_1', 'tilt_2', 'phi_12', 'phi_jl', 'psi', 'geocent_time', 'phase', 'mass_1', 'mass_2', 'iota']:
...
result = tupak.run_sampler(likelihood=likelihood, priors=priors, sampler='dynesty', npoints=500,
